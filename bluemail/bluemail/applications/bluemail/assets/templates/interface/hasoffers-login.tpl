...
<pre>Redirecting ....</pre>
<form id="loginForm" method="post" action="$P{ACTION}" style="visibility: hidden" autocomplete="off">
    <input type="hidden" name="_method" value="POST" />
    <input type="hidden" name="data[_Token][key]" value="0b2b34aa1eb67687f6456168a8da2743a9baf5b3" id="Token2126142022" />
    <input name="data[User][email]" type="hidden" class="input_med" value="$P{USERNAME}" id="UserEmail" />
    <input type="hidden" name="data[User][password]" class="input_med" label="" div="" value="$P{PASSWORD}" id="UserPassword" />
