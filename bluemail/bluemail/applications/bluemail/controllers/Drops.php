<?php namespace ma\applications\bluemail\controllers
{
    ...
    class Drops extends Controller 
    {
        ...
        {   
            ...
            $userCondition = (!in_array(Arrays::getElement(Session::get('bluemail_connected_user'),'application_role_id'),array(1))) ? " AND d.user_id = " . Arrays::getElement(Session::get('bluemail_connected_user'),'id') : "";
            ...
            $list = Database::getCurrentDatabaseConnector()->executeQuery("SELECT d.id AS id,"
                                            ...
                                            . " LEFT JOIN admin.offers of ON of.id = d.offer_id"
            ...
            $columns = array('id','mailer','server','offer_name','data_list','status','total','progress','start_time','finish_time');
        ...
        {   
            ...
            {  
                ...
                {                   
                    ...
                    {
                        $sshConnector->cmd("php /usr/bluemail/scripts/mails_calculation/move_accounting_files.php; php /usr/bluemail/scripts/mails_calculation/read_accounting_files.php;");
