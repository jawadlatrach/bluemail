<?php namespace ma\applications\bluemail\controllers
{
    ...
    use ma\applications\bluemail\models\admin\ApplicationRoles as ApplicationRoles;
    ...
    class Users extends Controller 
    {
        ...
        public function lists() 
        {
            ...
            if(!in_array(Arrays::getElement(Session::get('bluemail_connected_user'),'application_role_id'),array(1)))
            {
        ...
        public function edit() 
        {
            ...
            # check authorization access
            if(!in_array(Arrays::getElement(Session::get('bluemail_connected_user'),'application_role_id'),array(1)) && Arrays::getElement(Session::get('bluemail_connected_user'),'id') != $id)
            {
                throw new PageException("403 Access Denied",403);
            }
