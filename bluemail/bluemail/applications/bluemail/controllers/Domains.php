<?php namespace ma\applications\bluemail\controllers
{
    ...
    use ma\mfw\www\Domains as DomainsHelper;
    ...
    class Domains extends Controller 
    {
        ...
        public function download()
        {
            ...
            $domains = $namecheap->getAllDomains('all' , 1, 100 , 'NAME' , '');
            ...
            while (count($domains)) {
                ...
                foreach ($domains as $domain)
                {
                    ...
                    if (count($domainCheck) == 0)
                    {
                        ...
                        $domainObject->setLast_updated_by(intval(Arrays::getElement($user,'id',1)));
                        $domainObject->setLast_updated_at(date("Y-m-d"));
                        $res = $domainObject->save();
                    }
                }
                $domains = $namecheap->getAllDomains('all' , $index, 100 , 'NAME' , '');
                $index ++;
...
//            else 
//            {
//                $message = 'Can not find Any domain !';
//            }
