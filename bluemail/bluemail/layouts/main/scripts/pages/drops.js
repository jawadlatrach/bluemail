        ...
        dropSettings : function()
        {
            ...
            $(".recalculate-sent").on('click',function(evt)
            {
                ...
                if(dropId !== undefined && dropId !== '')
                {
                    ...
                    $.ajax({
                        type: 'post',
                        url: Bluemail.getBaseURL() + "/drops/recalculate/"+dropId+".json",
                        data :  {},
                        dataType : 'json',
            ...
            $(".drop-details").on('click',function(evt)
            {
                ...
                $("#details-modal .modal-body").html('<img src="' + Bluemail.getLayoutURL() + '/images/icons/loading.gif" alt="loading" />');
                ...
                if(dropId !== undefined && dropId !== '')
                {
                    $.ajax({
                        type: 'post',
                        url: Bluemail.getBaseURL() + "/drops/getDrop/"+dropId+".json",
                        data :  {},
                        dataType : 'json',
                        success:function(result) 
                        {
