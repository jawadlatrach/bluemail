    ...
    var handleServersAccessibilities = function () 
    {
        $('#servers-users,#providers').on('change',function(e)
        {
            ...
            {   
                ...
                $.ajax({
                    type: 'post',
                    url: Bluemail.getBaseURL() + "/accessibilities/getServers/"+userId+"/"+providerId+".json",
                    data :  {},
                    dataType : 'json',
                    async: false,
    ...
    var handleIspsAccessibilities = function () 
    {
        $('#isps-users').on('change',function(e)
        {
            ...
            {   
                ...
                $.ajax({
                    type: 'post',
                    url: Bluemail.getBaseURL() + "/accessibilities/getIsps/"+userId+".json",
                    data :  {},
                    dataType : 'json',
                    async: false,
                    success:function(result) 
    ...
    var handleOffersAccessibilities = function () 
    {
        $('#offers-users,#sponsors').on('change',function(e)
        {
            ...
            {   
                ...
                $.ajax({
                    type: 'post',
                    url: Bluemail.getBaseURL() + "/accessibilities/getOffers/"+userId+"/"+sponsorId+".json",
                    data :  {},
                    dataType : 'json',
                    async: false,
                    success:function(result) 
    ...
    var handleListsAccessibilities = function () 
    {
        $('#lists-users,#isps').on('change',function(e)
        {
            ...
            {   
                ...
                $.ajax({
                    type: 'post',
                    url: Bluemail.getBaseURL() + "/accessibilities/getLists/"+userId+"/"+ispId+".json",
                    data :  {},
                    dataType : 'json',
                    async: false,
                    success:function(result) 
