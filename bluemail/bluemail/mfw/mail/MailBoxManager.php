<?php namespace ma\mfw\mail
{
    ...
    use ma\mfw\exceptions\types\ConnectionException as ConnectionException;
    ...
    class MailBoxManager extends Base
    {
        ...
        /**
         * @name getEmailsISP
         * @description get emails ISP
         * @access public
         * @param array $email
         * @return string
         */
        public function getEmailsIsp($email)
        {
            $EmailIsp = Arrays::getElement(explode('.',Arrays::getElement(explode('@',$email),1)),0);
            
             if($EmailIsp == 'hotmail' || $EmailIsp == 'outlook' || $EmailIsp == 'msn')
            {
                return 'hotmail';
            }
