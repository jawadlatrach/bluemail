<?php namespace ma\mfw\application
{
    ...
    use ma\mfw\metadata\Inspector as Inspector;
    ...
    class Model extends Base
    {
         ...
         * @throws DatabaseException
         */
        public function save($returningId = true,$forceInsert = false) 
        {
            $primary = $this->getPrimaryColumn();
            ...
            {
                $data["{$primary["name"]}"] = $this->{$primary["raw"]};
            }
            ...
            {
                $result = $data["{$primary["name"]}"];
                $query->save($data,$schema,false); 
            }
